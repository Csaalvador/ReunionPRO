    ...
    <div class="d-flex vh-100">
        <div class="container d-flex justify-content-center align-items-center">
            <div class="text-center w-50">
                <figure class="figure">
                    <img src="images/login.png" class="figure-img img-fluid rounded login" alt="reuniao" style="width: 130px;">
                </figure>
                ...
                <form class="form-signin login-form w-100 m-auto" method="post" action="includes/check_login.php">
                    ...
                    <div class="form-floating form-email">
                        ...
                        <label for="email" class="form-label fw-normal" style=>Endereço de E-mail</label>
                    </div>
