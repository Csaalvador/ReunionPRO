        ...
        <div class="container text-center d-flex justify-content-center align-items-center">
            <div class="row justify-content-md-center text-center w-100">
                <div class="col-md-4 register-section">
                    <p>Registre-se no ReunionPro e simplifique suas reservas de salas de reunião!</p> 
                    <p>Com uma interface intuitiva e fácil de usar, o ReunionPro permite que você encontre e reserve salas de reunião de forma rápida e eficiente..</p>
                    <p>Cadastre-se agora e comece a gerenciar suas reuniões com mais organização e praticidade. Não perca tempo – junte-se a nós no ReunionPro e transforme a maneira como você organiza suas reuniões!</p>
                ...
                <div class="col-md-1 divider-container">
                    <figure class="figure">
                        <img src="images/login.png" class="figure-img img-fluid rounded-circle figure-login" alt="reuniao image">
                    </figure>
          ...
          <div class="modal-body">
            <form id="registerForm" method="post" action="includes/register.php">
                ...
                <div class="mb-3" id="password-requirements">
                    ...
                    <ul>
                        <li id="length" class="invalid">Mínimo 6 caracteres</li>
