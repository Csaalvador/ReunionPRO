        ...
        <div class="container text-center d-flex justify-content-center align-items-center">
            <div class="row justify-content-md-center text-center w-100">
                <div class="col-md-4 register-section">
                    <p>🎉 Conheça o ReunionPRO! 🎉</p> 
                    <p>Você está cansado de lutar com agendas confusas e reservas de salas desorganizadas? Conheça o ReunionPRO, a solução definitiva para otimizar o agendamento e a gestão de reuniões em sua empresa!</p>
                    <p>Experimente o ReunionPRO hoje e revolucione a forma como sua equipe se organiza!</p>
                ...
                <div class="col-md-1 divider-container">
                    <figure class="figure">
                        <img src="images/meet.png" class="figure-img img-fluid rounded-circle figure-login" alt="reunionPRO">
                    </figure>
